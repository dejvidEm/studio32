...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    statsDescription: "When selecting an agency, it's essential to consider its reputation, experience, and the specific needs of your project.",
    whoWeAre: "Who we are",
    // Services
    ...
    contactSendError: "We couldn’t send your message right now. Please try again later or email us directly.",
    placeholderName: "Name",
    placeholderEmail: "Email",
    contactServiceLabel: "Service of interest",
    contactServiceInquiry: "I would like to get information only",
    contactServiceBranding: "Branding",
    contactServiceWebsite: "Website",
    contactServiceContent: "Content creation",
    contactServiceMarketing: "Marketing",
  ...
  sk: {
    ...
    statsDescription: "Pri výbere agentúry je dôležité zvážiť jej povesť, skúsenosti a špecifické potreby vášho projektu.",
    whoWeAre: "Kto sme",
    servicesName: "Služby",
    ...
    contactSendError: "Správu sa nepodarilo odoslať. Skúste to prosím neskôr alebo napíšte priamo na e-mail.",
    placeholderName: "Meno",
    placeholderEmail: "E-mail",
    contactServiceLabel: "Služba, o ktorú majú záujem",
    contactServiceInquiry: "Chcem sa len informovať",
    contactServiceBranding: "Branding",
    contactServiceWebsite: "Webstránky",
    contactServiceContent: "Tvorba obsahu",
    contactServiceMarketing: "Marketing",
